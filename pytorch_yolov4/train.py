...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    print(config.val_label)
    val_dataset = Yolo_dataset(config.val_label, config, train=False)
    print('dataset : ',len(train_dataset), len(val_dataset))
...
def get_args(**kwargs):
    ...
    parser.add_argument('-g', '--gpu', metavar='G', type=str, default='-1',
                        help='GPU', dest='gpu')
    parser.add_argument('-dir', '--data-dir', type=str, default='./data/dataset/train/',
                        help='dataset dir', dest='dataset_dir')
    parser.add_argument('-pretrained', type=str, default='./pretrained yolov4.conv.137', help='pretrained yolov4.conv.137')
    parser.add_argument('-classes', type=int, default=3, help='dataset classes')
    parser.add_argument('-train_label_path', dest='train_label', type=str, default='./data/dataset/train/train.txt', help="train label path")
    parser.add_argument(
